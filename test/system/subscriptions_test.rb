...
class SubscriptionsTest < ApplicationSystemTestCase
  ...
  test "should create subscription" do
    ...
    fill_in "Current period end", with: @subscription.current_period_end
    fill_in "Current period start", with: @subscription.current_period_start
    fill_in "Customer", with: @subscription.customer_id
    fill_in "Interval", with: @subscription.interval
    fill_in "Plan", with: @subscription.plan_id
    fill_in "Status", with: @subscription.status
    fill_in "Subscription", with: @subscription.subscription_id
